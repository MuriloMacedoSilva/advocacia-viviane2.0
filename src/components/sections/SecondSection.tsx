...
export default function SecondSection() {
    return (
        <section className="w-full flex flex-col items-center justify-center px-[10%] md:px-[25%] gap-8 py-14 bg-linear-to-b from-white to-gray-100 ">
            ...
            <p className="text-center font-poppins font-normal text-gray-900 text-[12px] md:text-[16px]">Responsáveis pela engenharia jurídica e gestão de complience de operações transcontinentais, convertendo  crises de copnsumo em índices de retenção superiores à média do mercado.</p>

            <div className="flex flex-col items-center gap-3">
                <h2 className=" text-center text-brand2 font-medium font-Montserrat text-[26px] md:text-[36px]">
