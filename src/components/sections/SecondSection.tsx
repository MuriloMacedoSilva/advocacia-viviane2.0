export default function SecondSection() {
  return (
    <section className="w-full flex flex-col items-center justify-center px-[10%] md:px-[25%] gap-33 py-20 bg-linear-to-b from-white to-gray-100 ">
      ...
      <h3 className="font-poppins font-semibold text-black w-[85%] md:w-full text-[14px] md:text-[23px] justify-center  border-x-4 border-brand2 px-13 md:h-20 flex items-center text-center">
        Grande player na área de energia solar global
      </h3>

      <p className="text-center font-poppins font-normal text-gray-900 text-[16px]">
