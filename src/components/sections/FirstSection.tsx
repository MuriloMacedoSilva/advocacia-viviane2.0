...
export default function FirstSection() {
  ...
  return (
    <section className="relative w-full h-screen xl:h-auto 2xl:h-[80vh] flex flex-col items-center pt-27  xl:pt-0 justify-center">
      <video
      ref={videoRef}
      ...
      <div className="flex flex-col items-center xl:items-center justify-center w-[95%] xl:w-[71%] gap-6 xl:gap-10 2xl:gap-15 md:gap-12 mt-30 lg:mt-26 mb-50">
        <div className="border border-brand p-1.5 rounded-full font-semibold max-w-125 xl:mb-6.5">
          <p className="text-brand font-Montserrat xl:text-[12px] text-[8px] text-center">
            BLINDAGEM JURÍDICA E COMPLIENCE ESTRATÉGICO
          </p>
        </div>
        <h1 className="text-white font-Montserrat font-bold text-[40px] leading-12 xl:text-[64px] text-center xl:leading-18 mb-4 xl:mb-0">
          A invisibilidade do risco é o maior passivo do seu negócio.
        </h1>
        <p className="text-white font-poppins font-normal text-[12px] xl:text-[17px] text-center w-[90%] xl:w-[80%]">
